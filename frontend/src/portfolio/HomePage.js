		...
		<div className="main">
			...
			<div className = "About">
				<div className="About-Me">
					...
					things Computer Science and am pursuing fullstack or backend development. Thanks for checking out my website!
					</p>
					<h3>
			...
			<div className="Skills">
				...
				<div className = "Skills-list">
					<div className="skill1">Git Version Control
						<br></br>
						<img src = {GitHub_Mark} alt = "pic" className = "GithubPic"></img>
					</div>
					<div className="skill2">Frontend Development
					<br></br>
						<img src = {Frontend_Mark} alt = "pic" className = "FrontendPic"></img>
					</div>
					<div className="skill3">Backend Development
					<br></br>
						<img src = {Backend_Mark} alt = "pic" className = "BackendPic"></img>
					</div>
					<div className="skill4">Communication/Teamwork
					<br></br>
